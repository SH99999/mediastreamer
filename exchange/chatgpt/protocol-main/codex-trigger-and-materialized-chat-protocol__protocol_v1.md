...
last_event_utc: 2026-04-17T10:04:59Z
...
- related_git_objects:
  ...
  - review_target_artifacts:
### event 006
- event_utc: 2026-04-17T10:04:59Z
- event_type: main-inbox-trigger-published
- actor: codex
- summary: canonical main inbox trigger model implemented
- decisions:
  1.
- open_questions:
  1.
...
- related_git_objects:
  - live_session: exchange/chatgpt/sessions/codex-trigger-and-materialized-chat-protocol__live_v1.md
  - demand_intake: exchange/chatgpt/demands/codex-trigger-and-materialized-chat-protocol__intake_v1.md
  - source_branch: si/main-inbox-codex-trigger-and-protocol-snapshots-v1
  - source_pr_url: 
  - review_target_artifacts:
