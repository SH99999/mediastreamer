...
ControllerRadioScalePeppy.prototype.writeSettingsFile = function () {
  ...
  const settings = {
    ...
    pointer_visual_follow_gain: this.getNumberConfig('pointerVisualFollowGain', 0.52),
    pointer_visual_locked_gain: this.getNumberConfig('pointerVisualLockedGain', 0.62),
    pointer_idle_lock_ms: this.getNumberConfig('pointerIdleLockMs', 180),
    pointer_startup_settle_ms: this.getNumberConfig('pointerStartupSettleMs', 700),
    pointer_settle_epsilon_mhz: this.getNumberConfig('pointerSettleEpsilonMHz', 0.004),
    pointer_visual_deadband_mhz: this.getNumberConfig('pointerVisualDeadbandMHz', 0.0035),
    pointer_pixel_snap_deadband_px: this.getNumberConfig('pointerPixelSnapDeadbandPx', 0.45),
    ...
    overlay_owner_poll_ms: this.getNumberConfig('overlayOwnerPollMs', 120),
