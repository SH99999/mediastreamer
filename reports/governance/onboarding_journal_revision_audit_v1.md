...
_Generated: 2026-04-16T15:54:04.476076+00:00_

## Onboarding unification check
- governance_index_read_order_count: 35
- onboarding_read_order_count: 38
- overlap_count: 34
- jaccard_similarity: 0.872
- missing_read_order_paths_on_disk: 0

## Onboarding time estimate
- quick_path_minutes (30s per document): 19.0
- standard_path_minutes (60s per document): 38.0
- deep_path_minutes (105s per document): 66.5

## Journal revision audit
- components_with_versioned_streams: 8
- stale_write_violations: 0
- historical_marker_violations: 1
...
- stale_write_violation: `false`
- historical_marker_missing: `journals/system-integration-normalization/stream_v1.md, journals/system-integration-normalization/stream_v2.md, journals/system-integration-normalization/stream_v3.md, journals/system-integration-normalization/stream_v4.md, journals/system-integration-normalization/stream_v5.md`
